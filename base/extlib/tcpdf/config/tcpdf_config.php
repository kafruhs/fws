 ...
 * By default it is automatically set but you can also set it as a fixed string to improve performances.
 */
define ('K_PATH_IMAGES', ROOT . '/images/');
 ...
 * Document author.
 */
define ('PDF_AUTHOR', 'Faercher IT');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'MedEXchange');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Angebote von Apotheken für Apotheken");
