...
class base_ui_ACP extends base_ui_Site
{
    /**
    ...
    {
        $head = new base_ui_acp_HeadSection();
        $head->display($od);
    }
    ...
    {
        $navi = new base_ui_acp_Navigation();
        $navi->display($od);
    }
